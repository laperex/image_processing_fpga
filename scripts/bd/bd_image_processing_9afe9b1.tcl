set bCheckIPsPassed 1
  ...
  laperex.org:custom_axi_ip:ip_inrange:1.0\
  xilinx.com:ip:axis_data_fifo:2.0\
  laperex.org:custom_axi_ip:ip_rgb_to_hsv:1.0\
  "
...
\
  ...
  # Create instance: ip_inrange_0, and set properties
  set ip_inrange_0 [ create_bd_cell -type ip -vlnv laperex.org:custom_axi_ip:ip_inrange:1.0 ip_inrange_0 ]

  # Create instance: axis_data_fifo_0, and set properties
  set axis_data_fifo_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 axis_data_fifo_0 ]
  set_property CONFIG.TDATA_NUM_BYTES {8} $axis_data_fifo_0


  # Create instance: axis_data_fifo_1, and set properties
  set axis_data_fifo_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 axis_data_fifo_1 ]
  set_property CONFIG.TDATA_NUM_BYTES {8} $axis_data_fifo_1


  # Create instance: ip_rgb_to_hsv_0, and set properties
  set ip_rgb_to_hsv_0 [ create_bd_cell -type ip -vlnv laperex.org:custom_axi_ip:ip_rgb_to_hsv:1.0 ip_rgb_to_hsv_0 ]

  # Create interface connections
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axis_data_fifo_1/S_AXIS] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_1_M_AXIS [get_bd_intf_pins ip_rgb_to_hsv_0/s_axis] [get_bd_intf_pins axis_data_fifo_1/M_AXIS]
  connect_bd_intf_net -intf_net ip_inrange_0_m_axis [get_bd_intf_pins axis_data_fifo_0/S_AXIS] [get_bd_intf_pins ip_inrange_0/m_axis]
  connect_bd_intf_net -intf_net ip_rgb_to_hsv_0_m_axis [get_bd_intf_pins ip_rgb_to_hsv_0/m_axis] [get_bd_intf_pins ip_inrange_0/s_axis]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins ip_inrange_0/s_axil]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins processing_system7_0/S_AXI_HP2_ACLK] [get_bd_pins axi_mem_intercon/M01_ACLK] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins ip_inrange_0/m_axis_aclk] [get_bd_pins axis_data_fifo_1/s_axis_aclk] [get_bd_pins ip_rgb_to_hsv_0/s_axis_aclk] [get_bd_pins ip_inrange_0/s_axil_aclk] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ip_inrange_0/s_axis_aclk] [get_bd_pins ip_rgb_to_hsv_0/m_axis_aclk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M01_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon/S02_ARESETN] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins ip_inrange_0/m_axis_aresetn] [get_bd_pins axis_data_fifo_1/s_axis_aresetn] [get_bd_pins ip_rgb_to_hsv_0/s_axis_aresetn] [get_bd_pins ip_inrange_0/s_axil_aresetn] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ip_inrange_0/s_axis_aresetn] [get_bd_pins ip_rgb_to_hsv_0/m_axis_aresetn]
